...
#define GADGET_NAME "49000000.usb-otg"
...
static V1_0::Status validateAndSetVidPid(uint64_t functions) {
  ...
  switch (functions) {
    case static_cast<uint64_t>(GadgetFunction::MTP):
      ret = setVidPid(ST_VENDOR_ID, ST_MTP_PRODUCT_ID);
      break;
    case GadgetFunction::ADB | GadgetFunction::MTP:
      ret = setVidPid(ST_VENDOR_ID, ST_MTP_ADB_PRODUCT_ID);
      break;
    case static_cast<uint64_t>(GadgetFunction::RNDIS):
      ret = setVidPid(ST_VENDOR_ID, ST_RNDIS_PRODUCT_ID);
      break;
    case GadgetFunction::ADB | GadgetFunction::RNDIS:
      ret = setVidPid(ST_VENDOR_ID, ST_RNDIS_ADB_PRODUCT_ID);
      break;
    case static_cast<uint64_t>(GadgetFunction::PTP):
      ret = setVidPid(ST_VENDOR_ID, ST_PTP_PRODUCT_ID);
      break;
    case GadgetFunction::ADB | GadgetFunction::PTP:
      ret = setVidPid(ST_VENDOR_ID, ST_PTP_ADB_PRODUCT_ID);
      break;
    case static_cast<uint64_t>(GadgetFunction::ADB):
      ret = setVidPid(ST_VENDOR_ID, ST_ADB_PRODUCT_ID);
      break;
    default:
