...
constexpr char kVendorNcmConfig[] = "vendor.usb.ncm.config";
...
#define STRING_PATH CONFIG_PATH "strings/0x409/"
#define CONFIG_STRING_PATH STRING_PATH "configuration"
...
class MonitorFfs {
  ...
  public:
    ...
    // Get the name of the UDC
    void setGadgetName(std::string gadget);
};
